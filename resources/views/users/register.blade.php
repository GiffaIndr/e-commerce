...
<div class="container" id="container">
	<div class="form-container sign-in-container">
		<form action="{{route('register.input')}}" method="post" {{ csrf_field() }}
			@csrf
			<h1>Registrasi</h1>
			@if($errors->any())
	...
	<div class="overlay-container">
		<div class="overlay" style="background-image: linear-gradient(rgba(13, 199, 0, 0.379), rgba(255, 132, 0, 0.393)), url('{{asset('assets/img/pmn.jpeg')}}'); ">>
			...
			<div class="overlay-panel overlay-right">
				...
				<h1>Butuh bantuan? Hubungi Admin</h1><br><br>
                <center ><b style="text-decoration: underline;">(no telp admin)</b>(whatsapp)</center>
                <p><b>memiliki akun?</b> <a class="ghost" href="{{route('login')}}"  style="text-decoration: underline; color: white;" id="signUp">Login</a></p>
				<a class="ghost" href="" id="signUp"> </a>
			</div>
		</div>
	</div>
</div>
